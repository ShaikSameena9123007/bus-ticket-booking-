...
public class login extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Bus Ticket Booking");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if(Username.contains("saathvic")&& Password.contains("123")||Username.contains("seshu")&& Password.contains("456")||
            Username.contains("abhi")&& Password.contains("789")){
            JOptionPane.showMessageDialog(this,"Login Successful");
            busticket ob=new busticket();
            ob.setVisible(true);
            dispose();
        }
        else{
